...
EntityStuff::EntityStuff()
    :entity_manager(component_manager), system_manager(entity_manager, event_manager){}
...
void EntityStuff::update_systems(double dt)
{
...
EventManager & EntityStuff::get_event_manager()
{
